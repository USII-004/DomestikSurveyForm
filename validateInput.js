...
function removeItem() {
  if (previousOption == "cleaning") {
    ...
    document.getElementById("dog-walking").style.display = "block";    
  }else if (previousOption == "outdoor-errands") {
    document.getElementById("outdoor-errands").style.display = "block";    
  }else if (previousOption == "baby-sitting") {
    document.getElementById("baby-sitting").style.display = "block";    
  }else if (previousOption == "gardening") {
    document.getElementById("gardening").style.display = "block";    
  }else if (previousOption == "plumbering") {
    document.getElementById("plumbering").style.display = "block";    
  }else if (previousOption == "home-appliance-repair") {
    document.getElementById("home-appliance-repair").style.display = "block";    
  }
  ...
  if (selectedOption == "cleaning") {
    ...
    document.getElementById("dog-walking").style.display = "none";    
  }else if (selectedOption == "outdoor-errands") {
    document.getElementById("outdoor-errands").style.display = "none";    
  }else if (selectedOption == "baby-sitting") {
    document.getElementById("baby-sitting").style.display = "none";    
  }else if (selectedOption == "gardening") {
    document.getElementById("gardening").style.display = "none";    
  }else if (selectedOption == "plumbering") {
    document.getElementById("plumbering").style.display = "none";    
  }else if (selectedOption == "home-appliance-repair") {
    document.getElementById("home-appliance-repair").style.display = "none";    
  }
  previousOption = selectedOption;
}

//this code now works as expected as the removed items is returned whenever another item is
